...
public class ConversationListAdapterTest extends MockTestCase {
    ...
    public void testRemove() {
        ...
        mAdapter.remove(0);
        assertTrue(count != mAdapter.getCount());
    }

    public void testInsertInvalidArgument() {
        try {
            mAdapter.insert(-1, mConversationList.get(0));
            fail();
        } catch (IllegalArgumentException e) {
            // Ok
        }
    ...
    public void testInsert() {
        mAdapter.insert(1, mConversationList.get(0));
        assertEquals(mAdapter.getItem(1), mConversationList.get(0));
    }
}
